(async () => {
    ...
    const sounds = {
        "hartslag": new Audio("my_sounds/hartslag.mp3"),
        "reps": new Audio("my_sounds/harp.mp3"),
        "flexen": new Audio("my_sounds/juichen.mp3")
    };

    const images = {
        "hartslag": "my_images/hartslag 2.png",
        "reps": "my_images/reps 2.png",
        "flexen": "my_images/flexen 2.png",
        "Neutral": "my_images/neutraal 2.png"
    };
